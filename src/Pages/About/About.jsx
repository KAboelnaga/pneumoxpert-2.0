...
export default function About() {
    return (
        <div>
            ...
            <p className="aboutText">At PneumoXpert, we leverage cutting-edge technology to provide a seamless and efficient way for doctors and patients to upload X-ray images and detect pneumonia disease with precision.</p>
